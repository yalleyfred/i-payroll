...
const payRoute_1 = __importDefault(require("./routes/payRoute"));
...
app.use('/api/v1/employees', employeesRoute_1.default);
app.use('/api/v1/payslip', payslipRoute_1.default);
app.use('/api/v1/pay', payRoute_1.default);
app.use('/api/v1/payroll', payrollRoute_1.default);
